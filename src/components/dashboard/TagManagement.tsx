    ...
    <section style={{ marginBottom: 24 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12, marginBottom: 20 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <h2 style={{ fontSize: 22, fontWeight: 700 }}>
            <span style={{ color: "var(--txt)" }}>Akcje</span>
          </h2>
          <span style={{ background: "transparent", color: "var(--txt-sec)", fontSize: 12, fontWeight: 600, padding: "3px 10px", borderRadius: 20 }}>
            {displayTags.length}
          </span>
        </div>
        ...
        <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            ...
            {(["cards", "table"] as const).map((mode) => (
              <button
                ...
                style={{
                  ...
                  color: viewMode === mode ? "var(--txt)" : "var(--txt-muted)",
          ...
          <div style={{ width: 1, height: 24, background: "var(--border-hover)" }} />
          {resetAllConfirm ? (
            <>
              <span style={{ fontSize: 12, color: "var(--error)", fontWeight: 600 }}>Na pewno usunac WSZYSTKIE statystyki?</span>
              <button
                onClick={() => handleResetStats()}
                disabled={resetting}
                style={{ background: "rgba(239,68,68,0.2)", border: "1px solid rgba(239,68,68,0.4)", color: "var(--error)", borderRadius: 6, padding: "6px 14px", fontSize: 12, cursor: "pointer", fontWeight: 700 }}
              >
                {resetting ? "Usuwanie..." : "TAK, usun wszystko"}
              </button>
              <button
                onClick={() => setResetAllConfirm(false)}
                style={{ background: "transparent", border: "1px solid var(--border)", color: "var(--txt-sec)", borderRadius: 6, padding: "6px 14px", fontSize: 12, cursor: "pointer" }}
              >
                Anuluj
              </button>
            </>
            ...
            <button
              ...
              style={{ background: "transparent", border: "1px solid var(--border)", color: "var(--txt-sec)", borderRadius: 8, padding: "7px 16px", fontSize: 12, fontWeight: 500, cursor: "pointer", transition: "border-color 0.2s, color 0.2s" }}
              onMouseEnter={(e) => { e.currentTarget.style.borderColor = "var(--error)"; e.currentTarget.style.color = "var(--error)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.borderColor = "var(--border-hover)"; e.currentTarget.style.color = "#a0a0c0"; }}
            >
      ...
      {isAdmin && (
        <div style={{ marginBottom: 20 }}>
          <button
            ...
            style={{
              background: "var(--accent)", border: "none", color: "var(--bg)", borderRadius: 10,
      ...
      {displayTags.length === 0 && (
        <div className="card" style={{ textAlign: "center", padding: "40px 24px" }}>
          <p style={{ color: "var(--txt-muted)", fontSize: 14 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12, marginBottom: 8 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                  <span style={{ fontSize: 11, fontWeight: 600, color: "var(--txt-muted)", textTransform: "uppercase" as const, letterSpacing: "0.06em" }}>
                    {tag.name}
                  </span>
                  <span style={{ fontSize: 11, fontWeight: 600, padding: "2px 8px", borderRadius: 4, background: tag.isActive ? "rgba(16,185,129,0.15)" : "rgba(239,68,68,0.15)", color: tag.isActive ? "var(--success)" : "var(--error)" }}>
                  ...
                  {tag.videoFile && (
                    <span style={{ fontSize: 11, fontWeight: 600, padding: "2px 8px", borderRadius: 4, background: "rgba(16,185,129,0.15)", color: "var(--success)" }}>
                      Video wgrane
                    </span>
                  )}
                  {tag.client && (
                  ...
                  {tag.campaign && (
                    <span style={{ fontSize: 11, fontWeight: 600, padding: "2px 8px", borderRadius: 4, background: "rgba(96,165,250,0.12)", color: "var(--accent)", display: "flex", alignItems: "center", gap: 4 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  ...
                  {isAdmin && (
                    <button
                      ...
                      style={{ width: 44, height: 24, borderRadius: 8, background: tag.isActive ? "var(--success)" : "var(--border-hover)", border: "none", cursor: "pointer", position: "relative", transition: "background 0.2s", flexShrink: 0 }}
                    >
                  ...
                  <button
                    ...
                    style={{ background: "transparent", border: "1px solid var(--border)", color: copiedCardId === tag.id ? "var(--success)" : "var(--txt-sec)", borderRadius: 6, width: 28, height: 28, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, transition: "color 0.15s, border-color 0.15s" }}
                    onMouseEnter={e => { if (copiedCardId !== tag.id) { e.currentTarget.style.color = "var(--accent-light)"; e.currentTarget.style.borderColor = "var(--accent)"; } }}
                    onMouseLeave={e => { if (copiedCardId !== tag.id) { e.currentTarget.style.color = "var(--txt-sec)"; e.currentTarget.style.borderColor = "var(--border-hover)"; } }}
                  >
                    {copiedCardId === tag.id
                  ...
                  <button
                    ...
                    style={{ background: "transparent", border: "1px solid var(--border)", color: "var(--txt-sec)", borderRadius: 6, width: 28, height: 28, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, transition: "color 0.15s, border-color 0.15s" }}
                    onMouseEnter={e => { e.currentTarget.style.color = "var(--txt)"; e.currentTarget.style.borderColor = "var(--accent)"; }}
                    onMouseLeave={e => { e.currentTarget.style.color = "var(--txt-sec)"; e.currentTarget.style.borderColor = "var(--border-hover)"; }}
                  >
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                  ...
                  {isAdmin && (
                    <div style={{ position: "relative" }}>
                      <button
                        ...
                        title="Więcej opcji"
                        style={{ background: "transparent", border: "1px solid var(--border)", color: "var(--txt-sec)", borderRadius: 6, width: 32, height: 32, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, lineHeight: 1, letterSpacing: "0.05em", flexShrink: 0, transition: "border-color 0.15s, color 0.15s" }}
                        onMouseEnter={(e) => { e.currentTarget.style.borderColor = "var(--accent)"; e.currentTarget.style.color = "var(--txt)"; }}
                        onMouseLeave={(e) => { e.currentTarget.style.borderColor = "var(--border-hover)"; e.currentTarget.style.color = "var(--txt-sec)"; }}
                      >
                        ⋯
                      </button>
                      ...
                      {openMenuId === tag.id && menuRect && (
                        <CtxMenuPortal anchorRect={menuRect} onClose={closeCardMenu}>
                          ...
                          <button
                            ...
                            style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", padding: "10px 14px", background: "transparent", border: "none", color: "var(--success)", fontSize: 13, cursor: "pointer", textAlign: "left" }}
                          ...
                          <button
                            ...
                            style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", padding: "10px 14px", background: "transparent", border: "none", color: "var(--accent-light)", fontSize: 13, cursor: "pointer", textAlign: "left" }}
                            onMouseEnter={(e) => { e.currentTarget.style.background = "var(--surface-3)"; }}
                            onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; }}
                          >
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <>
                              ...
                              {tag.videoFile && (
                                <button
                                  ...
                                  style={{ display: "flex", alignItems: "center", gap: 10, width: "100%", padding: "10px 14px", background: "transparent", border: "none", color: "var(--error)", fontSize: 13, cursor: "pointer", textAlign: "left" }}
                                  onMouseEnter={(e) => { e.currentTarget.style.background = "var(--surface-3)"; }}
                                  onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; }}
                                >
                                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* Bottom row: details */}
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10, fontSize: 12, color: "var(--txt-sec)", alignItems: "center" }}>
                <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
                  <span style={{ color: "var(--txt-muted)" }}>ID:</span>{" "}
                  <span style={{ fontFamily: "var(--font-mono)", color: "var(--accent-light)" }}>{tag.id}</span>
                </span>
                <span>
                  <span style={{ color: "var(--txt-muted)" }}>Skany:</span>{" "}
                  <span style={{ fontWeight: 600, color: "var(--txt)" }}>{tag._count.scans}</span>
                </span>
                ...
                <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
                  ...
                  >
                    <span style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--accent-light)" }}>/s/{tag.id}</span>
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="var(--txt-sec)" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <a
                    ...
                    style={{ color: "var(--txt-muted)", display: "inline-flex", alignItems: "center", transition: "color 0.15s" }}
                ...
                {tag.videoFile && (
                  <span>
                    <span style={{ color: "var(--txt-muted)" }}>Video:</span>{" "}
                    <a
                      href={tag.videoFile.replace(/^\/uploads\//, "/api/video/")}
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "var(--success)", fontSize: 11, textDecoration: "underline", cursor: "pointer" }}
                    >
              ...
              {tag.tagType === "multilink" && (
                <div style={{ marginTop: 8 }}>
                  <button
                    ...
                    style={{ background: "transparent", border: "none", color: "var(--accent)", fontSize: 12, cursor: "pointer", padding: 0, display: "flex", alignItems: "center", gap: 4, fontWeight: 500 }}
                  >
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"
                  ...
                  {expandedLinkStats === tag.id && linkClickStats[tag.id] && (
                    <div style={{ marginTop: 8, padding: 12, background: "var(--bg)", borderRadius: 8, border: "1px solid var(--border)" }}>
                      {linkClickStats[tag.id].links.length === 0 ? (
                        <p style={{ fontSize: 12, color: "var(--txt-muted)" }}>Brak klikniec</p>
                      ) : (
                        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                          {linkClickStats[tag.id].links.map((lc, idx) => (
                            <div key={idx} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "6px 0", borderBottom: idx < linkClickStats[tag.id].links.length - 1 ? "1px solid var(--surface-3)" : "none" }}>
                              <div style={{ display: "flex", alignItems: "center", gap: 8, flex: 1, minWidth: 0 }}>
                                <span style={{ fontSize: 11, color: "var(--txt-sec)", fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                                  {lc.linkLabel || lc.linkUrl}
                                </span>
                              </div>
                              <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                                <div style={{ width: 60, height: 4, background: "transparent", borderRadius: 2, overflow: "hidden" }}>
                                  <div style={{ width: `${lc.percent}%`, height: "100%", background: "var(--accent)", borderRadius: 2 }} />
                                </div>
                                <span style={{ fontSize: 12, fontWeight: 700, color: "var(--txt)", minWidth: 24, textAlign: "right" }}>{lc.clicks}</span>
                                <span style={{ fontSize: 10, color: "var(--txt-muted)", minWidth: 28, textAlign: "right" }}>{lc.percent}%</span>
                              </div>
                            </div>
                          ))}
                          <div style={{ fontSize: 11, color: "var(--txt-muted)", marginTop: 4, paddingTop: 6, borderTop: "1px solid var(--surface-3)" }}>
                      ...
                      <button
                        ...
                        style={{ background: "transparent", border: "none", color: "var(--accent)", fontSize: 11, cursor: "pointer", padding: "4px 0 0 0", textDecoration: "underline" }}
                      >
                        Odswiez
                      </button>
                    </div>
              ...
              {tag.tagType === "video" && (
                <div style={{ marginTop: 8 }}>
                  <button
                    ...
                    style={{ background: "transparent", border: "none", color: "var(--success)", fontSize: 12, cursor: "pointer", padding: 0, display: "flex", alignItems: "center", gap: 4, fontWeight: 500 }}
                  >
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"
                  ...
                  {expandedVideoStats === tag.id && videoStats[tag.id] && (
                    <div style={{ marginTop: 8, padding: 12, background: "var(--bg)", borderRadius: 8, border: "1px solid var(--border)" }}>
                      <div style={{ display: "flex", gap: 16, flexWrap: "wrap", alignItems: "center", marginBottom: 8 }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                          <span style={{ fontSize: 18, fontWeight: 700, color: "var(--success)" }}>{videoStats[tag.id].plays}</span>
                          <span style={{ fontSize: 11, color: "var(--txt-sec)" }}>odtworzen</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                          <span style={{ fontSize: 18, fontWeight: 700, color: "var(--accent)" }}>{videoStats[tag.id].completions}</span>
                          <span style={{ fontSize: 11, color: "var(--txt-sec)" }}>do konca</span>
                        </div>
                        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                          <span style={{ fontSize: 18, fontWeight: 700, color: "var(--accent-light)" }}>{formatWatchTime(videoStats[tag.id].avgWatchTime)}</span>
                          <span style={{ fontSize: 11, color: "var(--txt-sec)" }}>sred. czas</span>
                        </div>
                        {videoStats[tag.id].plays > 0 && (
                          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                            ...
                            <span style={{ fontSize: 11, color: "var(--txt-sec)" }}>completion rate</span>
                          </div>
                        )}
                      </div>
                      <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                        <button
                          ...
                          style={{ background: "rgba(16,185,129,0.12)", border: "1px solid rgba(16,185,129,0.25)", color: "var(--success)", fontSize: 11, cursor: "pointer", padding: "4px 12px", borderRadius: 6, fontWeight: 600 }}
                        >
                          Zobacz pelny wykres retencji
                        </button>
                        <button
                          onClick={() => fetchVideoStats(tag.id)}
                          style={{ background: "transparent", border: "none", color: "var(--success)", fontSize: 11, cursor: "pointer", padding: "4px 0", textDecoration: "underline" }}
                        >
                          Odswiez
                        </button>
                      </div>
